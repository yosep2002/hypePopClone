...
public class SupportController {
	...
	public ResponseEntity<Map<String, Object>> replyCheck(
	    ...
	    Map<String, Object> response = new HashMap<>();
	    List<qnaVO> inquiries = noticeService.replyCheckInquiries(pageNum, amount, userNo, answered);
	    int totalCount = noticeService.replyCheckCount(userNo, answered); // 총 문의 개수 가져오기
	    response.put("inquiries", inquiries);
	    response.put("totalCount", totalCount); 
